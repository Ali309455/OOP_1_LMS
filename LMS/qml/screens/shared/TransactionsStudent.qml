...
import LMS
Rectangle {
    /// the only change is filteration the tab shows only the current user transactions YES Violate DRY principle future Insight is
    ...
    for (let i = 0; i < txData.length; i++) {
        if(root.currentUser.userId === txData[i].sId)
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        root.issueStudent = root.currentUser.name; root.issueStudentId = root.currentUser.userId
                                    ...
                                    Rectangle {
                                        ...
                                        Row {
                                            ...
                                            Column {
                                                ...
                                                anchors.verticalCenter: parent.verticalCenter
                                                spacing: 2
                                                // Text { text: title; color: root.textPrimary; font.pixelSize: 13; font.bold: true; elide: Text.ElideRight; width: parent.width - 8 }
        ...
        Column {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Text { text: "Due Date:   " + root.dueDateStr(7); color: "#f59e0b"; font.pixelSize: 12; font.bold: true }
                }
            }

...
public:
    ...
    static bool addReview(QString review_id, QString userId, QString isbn, int rating, QString comment, QString status);
    ...
    //update
    static bool updateUser(QString id, QString name, QString email, QString password, QString membership, QString role);
